          ...
          >
            ...
            {mode === "login" && (
              <div className="mt-4 text-center text-xs text-zinc-400">
                Are you staff? <button type="button" onClick={() => window.location.href = "/staff/login"} className="font-semibold text-white hover:text-[var(--pizo-gold)]">Staff login</button>
              </div>
            )}
          </motion.div>
        </motion.div>
